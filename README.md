# Holamama REST API | Hapi based REST application boilerplate, uses async/await
...
- Build the docker image
    - `docker build -t holamama-api .`
- Start Docker Container
    - `docker run -d -p 3000:3000 --name holamama-api holamama-api` 

## Documentation
- `hapi-swagger` self documents all the APIs.
- Visit `http://localhost:3000/documentation` to access the documentation after starting the server.
